            ...
            {row.map((demo, index) => (
              <div key={index} className="relative group overflow-hidden py-4 px-4">
                <img 
                  src={demo.image} 
                  alt={demo.title} 
                  className="shadow-lg w-full rounded-lg shadow-md object-cover transform transition-transform duration-300 group-hover:-translate-y-2" 
                />
              ...
              {featuredItems.map((item, index) => (
                <div
                  ...
                  className={`bg-gray-100 p-4 rounded-lg shadow-md hover:bg-gray-200 transition ${
                    item.special ? 'bg-purple-200 hover:bg-purple-300' : ''
                  }`}
                >
                  <h4
                    className={`text-gray-700 font-medium ${
                      item.special ? 'text-purple-800' : ''
                    }`}
                  >
                    {item.title} &rsaquo;
                  </h4>
                  <img src={item.image} alt={item.title} className="mt-2 rounded-lg" />
                </div>
              ))}
            </div> */}
          </div>
