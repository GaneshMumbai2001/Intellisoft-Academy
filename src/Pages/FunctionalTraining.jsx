...
import FdHeader from "../Components/CourseDetails/FdHeader"; // Correct import path
import FdGridView from "../Components/CourseDetails/FdGridview"; // Correct import path
import FdListView from "../Components/CourseDetails/FdListview"; // Correct import path
...
const FunctionalTraining = () => {
  ...
  return (
    <div>
      ...
      <FdHeader view={view} setView={setView} setSearchQuery={setSearchQuery} />
      ...
      >
       {view === "grid" ? (
         <FdGridView courses={filteredCourses} />
         ) : (
        <FdListView courses={filteredCourses} />
      )}
