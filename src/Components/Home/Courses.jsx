...
//     description: "Mindset improvement.",
//     link: "#course2"
//   },
//   {
//     id: 3,
...
// const Courses = () => {
//   return (
//     <div className="flex flex-wrap gap-1 justify-center bg-[#F9F9FF] p-10  w-full">
//       {/* <div className="flex flex-wrap gap-12 justify-center bg-[#3434ce] p-12   w-full"></div> */}
//       {/* Mapping over courses data to dynamically generate course cards */}
//       {courses.map((course) => (
