...
const LanguageNews = () => {
  const cardData = [
    { imgSrc: lan1, title: "Basics of HiStudy Theme", icon: c1, programs: "21 programs", link: "#" },
    { imgSrc: lan2, title: "French Courses", icon: c2, programs: "32 programs", link: "#" },
    { imgSrc: lan3, title: "German Courses", icon: c3, programs: "21 programs", link: "#" },
    { imgSrc: lan4, title: "Italian Courses", icon: c4, programs: "5 programs", link: "#" },
    { imgSrc: lan5, title: "Spanish Courses", icon: c5, programs: "8 programs", link: "#" },
    { imgSrc: lan6, title: "Japanese Courses", icon: c6, programs: "10 programs", link: "#" }
  ];
