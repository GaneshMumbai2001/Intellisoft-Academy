...
const CoursesHeader = ({ setView, view, setSearchQuery }) => {
  ...
  return (
    <motion.div
      ...
      className="py-10 md:py-20 w-full flex justify-center bg-gradient-to-b from-blue-400 to-purple-400"
    >
      <section className="w-full max-w-6xl px-4 text-white">
        <nav className="text-xs md:text-sm text-gray-200">Home . All Courses</nav>
