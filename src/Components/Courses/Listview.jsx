...
//   return (
//     <div className="relative top-100px  py-10 flex flex-col items-center">
//       <motion.div
//         className="w-full lg:max-w-6xl flex flex-col gap-6"
...
//           <motion.div
//             key={index}
//             className="bg-white shadow-lg rounded-xl p-5 flex gap-6 transition-transform hover:scale-105"
//             initial={{ opacity: 0, scale: 0.9 }}
//             whileInView={{ opacity: 1, scale: 1 }}
//             transition={{ duration: 0.4, delay: index * 0.1 }}
//             viewport={{ once: true }}
//           >
//             <img className="w-40 h-40 rounded-lg" src={course.imageLink} alt={course.courseName} />
    ...
    <div className="py-10 flex flex-col items-center">
      ...
      >
        {courses.map((course, index) => (
          <motion.div
            key={index}
            className="bg-white shadow-lg rounded-xl p-5 flex flex-wrap gap-6 transition-transform hover:scale-105"
            initial={{ opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.4, delay: index * 0.1 }}
            viewport={{ once: true }}
