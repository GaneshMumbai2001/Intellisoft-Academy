...
const FdHeader = ({ setView, view, setSearchQuery }) => {
  ...
  return (
    ...
    >
      <section className="w-full max-w-6xl px-4  text-black">
        <nav className="text-xs md:text-sm text-black">Home .Functional Training</nav>
        ...
        >
          <h1 className="text-2xl md:text-3xl font-bold  text-black">Functional Training</h1>
