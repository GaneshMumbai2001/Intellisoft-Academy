...
const CoreHeader = ({ setView, view, setSearchQuery }) => {
  ...
  return (
    ...
    >
      <section className="w-full max-w-6xl px-4  text-black">
        <nav className="text-xs md:text-sm text-black">Home .Core Functions</nav>
        ...
        >
          <h1 className="text-2xl md:text-3xl font-bold  text-black">Core Functions</h1>
