      ...
      >
        {courses.map((course, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Link to={`/core/${course.id}`} className="bg-white shadow-lg rounded-xl p-5 flex flex-wrap gap-6 transition-transform hover:scale-105 m-8">
