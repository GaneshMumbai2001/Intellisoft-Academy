...
const ArtHeader = ({ setView, view, setSearchQuery }) => {
  ...
  return (
    ...
    >
      <section className="w-full max-w-6xl px-4  text-black">
        <nav className="text-xs md:text-sm text-black">Home .Art & Humanities</nav>
        ...
        >
          <h1 className="text-2xl md:text-3xl font-bold  text-black">Art & Humanities</h1>
