...
//             className={`px-4 py-2 rounded-md transition-all ${activeComponent === buttonIndex ? "bg-blue-600 text-white" : "bg-gray-200 text-black"}`}
//           >
//             {buttonIndex}
//           </button>
//         ))}
...
import BlogCard2 from './BlogCard2';
import BlogCard3 from './BlogCard3';
// import BlogCard4 from './BlogCard4'; // Import BlogCard4
// import BlogCard5 from './BlogCard5'; // Import BlogCard5
// import BlogCard6 from './BlogCard6'; // Import BlogCard6
      ...
      case 1:
        return (
          <div className="p-5 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 gap-4 mt-5">
              {selectedData.slice(1).map((item) => (
                <div key={item.id} className="bg-white p-4 shadow-md rounded-lg flex flex-wrap items-center space-x-4">
                  <img src={item.image} alt={item.title} className="w-72 h-32 object-cover rounded" />
                  <div>
                    <h2 className="text-lg font-bold">{item.title}</h2>
                    <p className="text-gray-600 text-sm">{item.description}</p>
                  </div>
