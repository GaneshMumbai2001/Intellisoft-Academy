...
//         {/* Buttons */}
//         <button onClick={() => addToCart({ id, name: "Example Course" })}>
//                 Add to Cart
//             </button>
//         <Link to="/user/cart">
//           <button className="mt-2 w-full border border-gray-300 text-gray-700 py-2 rounded-lg font-semibold">
//             Go to Cart
//           </button>
//         </Link>
...
//   // Safe handling of `useCourse`
//   const courseContext = useCourse();
//   const addToCart = courseContext ? courseContext.addToCart : () => {};
...
//             By <span className="font-semibold">Rainbow Themes</span>
//           </p>
//           <div className="mt-4">
//             <CourseImage image={course.image} alt={course.title} />
//           </div>
...
//             {/* Buttons */}
//             <button
//               onClick={() => addToCart({ id, name: course.title })}
//               className="mt-4 w-full bg-blue-500 text-white py-2 rounded-lg font-semibold"
//             >
//               Add to Cart
//             </button>
...
//                 className="mt-2 block bg-gradient-to-r from-purple-500 to-blue-500 text-white px-4 py-2 rounded-lg font-semibold"
//               >
//                 Call Us: {course.contact}
//               </a>
//             </div>
