...
import instructorImage from "../Coursebundle1/cbimage/co3.png";
import coursePreview from "../Coursebundle1/cbimage/co3.png";
...
const AboutCourse = {
  Description:
    "Software development services on a comprehensive React journey with our React Front To Back course. Designed for beginners and seasoned developers alike, this course covers the fundamentals and dives deep into advanced topics."
};
...
const courseContent = [
  {
    ...
    id: "introContent",
    lessons: [
      "Let's learn Software development services from scratch with projects",
      "How to learn Software development services | A React Roadmap"
    ]
  },
  {
    title: "Understand Software development services",
    id: "reactBasics",
