...
const CourseCards = () => {
  return (
    <div className="flex flex-wrap justify-center gap-6 p-6 bg-gray-100 p-20">
      {/* Card 1 */}
      <div className="bg-white rounded-2xl shadow-lg p-5 w-full max-w-md md:max-w-lg flex flex-col md:flex-row items-center justify-between">
        {/* Left Content */}
        <div className="flex-1 p-4">
          <span className="text-sm bg-gray-200 px-3 py-1 rounded-full">New Collection</span>
          <h3 className="text-lg font-semibold mt-3">Online Courses from Intellisoft</h3>
      ...
      {/* Card 2 */}
      <div className="bg-white rounded-2xl shadow-lg p-5 w-full max-w-md md:max-w-lg">
        ...
        <h3 className="text-lg font-semibold mt-3">
          Free Online Courses from Intellisoft School To Education
        </h3>
        <p className="text-gray-500 text-sm">Top instructors from around the world</p>
